...
public class DesignerDAO {
		...
		public void schedule(Connection connection,TimeTableDTO timeTableDTO) { // 일정관리
			try {
				String updateSql ="UPDATE timetable SET status = '예약 불가' WHERE ttime = ?";
				PreparedStatement preparedStatement = connection.prepareStatement(updateSql);
				preparedStatement.setString(1, timeTableDTO.getTtime());
		...
		public void schedule3(Connection connection, TimeTableDTO timeTableDTO) { // 일정관리
			try {
		...
		public void search(Connection connection, BookDTO searchDTO) { // 예약검색
