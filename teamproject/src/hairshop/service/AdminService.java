...
public class AdminService {
	...
	Scanner scanner = new Scanner(System.in);
		...
		public void adminMenu(Connection connection) { // 관리자 1 디자이너 2 고객 3
			...
			while (adminMenuRun) {
				...
				case 1:
					...
					manageCut(connection);
					break;
				case 2:
					System.out.println("매장 관리");
					manageShop(connection);
					break;
				case 3:
					System.out.println("계정 관리");
					manageAccount(connection);
					break;
				case 4:
		...
		public void manageCut(Connection connection) { // 헤어컷 관리 메뉴
			...
			while (hairMenuRun) {
				...
				case 3:
					...
					manageCutEdit(connection);
					break;
				case 4:
					System.out.println("헤어컷 제거를 진행합니다.");
					manageHairDelete(connection);
					break;
				case 5:
		...
		public void manageCutAdd(Connection connection) { // 헤어컷 추가 메서드
		...
		public void manageCutEdit(Connection connection) { // 헤어컷 수정 메서드
			...
			case 1: // String 타입 처리
				...
				toCutEditString(ccode, updateCut,connection);
				break;
			case 2: // int 타입 처리
				System.out.println("매장 번호을 변경합니다.");
				updateCut = "csno"; // 바꾸길 원하는 값 입력
				toCutEditInt(ccode, updateCut,connection);
				break;
			case 3: // String
		...
		public void toCutEditString(int ccode, String updateCut,Connection connection) { // CutEditString 메서드로 전달하는 메서드
		...
		public void toCutEditInt(int ccode, String updateCut,Connection connection) { // CutEditInt 메서드로 전달하는 메서드
			System.out.print("변경 값 입력 : ");
		...
		public void manageHairDelete(Connection connection) { // 헤어컷 삭제 메서드
			System.out.println("아래 내용을 입력해 주세요.");
		...
		public void manageShop(Connection connection) { // 매장 관리 메뉴
			...
			while (shopMenuRun) {
				...
				case 3:
					...
					manageShopEdit(connection);
					break;
				case 4:
					System.out.println("매장 제거를 진행합니다.");
					manageShopDelete(connection);
					break;
				case 5:
		...
		public void manageShopAdd(Connection connection) { // 매장을 추가하는 메서드
			System.out.println("아래 내용을 입력해 주세요.");
		...
		public void manageShopEdit(Connection connection) { // 매장 정보를 수정하는 메서드
			...
			case 1:
				...
				toCutEditString(sno, updateShop,connection);
				break;
			case 2:
			...
			case 3:
				...
				toCutEditInt(sno, updateShop,connection);
				break;
			case 4:
		...
		public void toshopEditString(int sno, String updateShop,Connection connection) { // shopEditString 메서드로 전달하는 메서드
			System.out.print("변경 값 입력 : ");
			String inputSt = scanner.next();
		...
		public void toshopEditInt(int sno, String updateShop,Connection connection) { // shopEditInt 메서드로 전달하는 메서드
			System.out.print("변경 값 입력 : ");
			int inputIn = scanner.nextInt();
			ShopDTO shopdto = new ShopDTO();
			shopdto.setSno(sno);
		...
		public void manageShopDelete(Connection connection) { // 매장을 삭제하는 메서드 
			System.out.println("아래 내용을 입력해 주세요.");
		...
		public void manageAccount(Connection connection) {
		...
		public void accountGradeEdit(Connection connection) {
			System.out.println("아래 내용을 입력해 주세요.");
			...
			ShopDAO shopdao = new ShopDAO();
			shopdao.memberGradeEdit(memberNo, connection);
